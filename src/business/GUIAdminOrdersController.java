...
public class GUIAdminOrdersController {
	...
	public void removeService(ActionEvent event) {
		...
		if (serviceSelected == null) {
			LogicAlert.alertMessage("Debe Seleccionar un Servicio en la Tabla Para Elimnarlo");
			return;
		}
	...
	public void editOrder(ActionEvent event) {
		Orders order = OrderSelectedTV();
		if(order == null) {
			LogicAlert.alertMessage("Debe Selaccionar una Orden en la Tabla");
			return;
		}
		if(validForm()) {
			return;
	...
	// Event Listener on Button[#btnAddPhotos].onAction
	@FXML
